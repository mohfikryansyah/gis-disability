        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body py-4-5 px-4">
                    <form action="{{ route('dashboard.layanan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <x-form.input type="text" name="nama" label="Nama Layanan" />
                        <x-form.select name="jenis" label="Jenis Layanan" :options="[
                            (object) [
                        ...
                        <x-form.input type="text" name="kontak" label="Nomor HP" format="phone" maxlength="13" />
