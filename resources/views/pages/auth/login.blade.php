...
@section('content')
    <section class="position-relative">
        <p class="position-absolute pt-2 ps-2 z-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left"
                viewBox="0 0 16 16">
                <path fill-rule="evenodd"
                    d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8" />
            </svg>
            <a href="/" class="text-secondary">Kembali ke halaman utama.</a>
        </p>
                ...
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        ...
                        <p class="fw-medium fs-5">
                            {{ config('app.name') }} adalah platform yang memungkinkan relawan dan admin untuk melakukan
                            pendataan penyandang disabilitas, dilengkapi dengan pemetaan (GIS) untuk lokasi penyandang
                            disabilitas dan pengelolaan bantuan kepada penyandang dari relawan di tiap-tiap lokasi tertentu.
                        </p>
                    </div>
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        <div class="card p-md-3">
                            ...
                            <form action="{{ route('auth.login.authenticate') }}" method="POST" class="card-body">
                                @csrf
                                <x-form.input type="text" name="username" label="Username / Email"
